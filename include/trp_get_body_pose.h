...
namespace gazebo
{
    class TRPGetBodyPosePlugin : public ModelPlugin
    {
        public:
            TRPGetBodyPosePlugin(); // Constructor

            virtual ~TRPGetBodyPosePlugin(); //Destructor
    ...
    GZ_REGISTER_MODEL_PLUGIN(TRPGetBodyPosePlugin)
}